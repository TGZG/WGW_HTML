//页面加载完成后初始化所有功能
//本文件用于将页面的【预约人数：xx 人】修改为【Number of reservations：xx people】，修改、且只修改了183行。2025.4.30.15.30修改
//新增修改：弹窗的【昵称、手机号、邮箱】。2025.4.30.17.00修改
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    preorderLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // console.log(1);
            const formType = link.classList.contains('online') ? 'Official Server Online Version' :
                link.classList.contains('dlc') ? 'Great Strife Era DLC' : 'Single-player Mode';
        ...
        <form id="preorder-form">
          ...
          <div style="margin-bottom:15px;">
            <label for="name" style="color: black;">Nickname (optional):</label>
...
function getUserCount(url, className) {
    ...
    fetch('./PHP/userCount_singleMachine.php', {
        ...
        .then(data => {
            ...
            reservationCounter.textContent = 'Number of reservations：' + userCount_singleMachine.toString() + ' people';
            // 在这里可以使用userCount变量
            // console.log('预约人数：', userCount_singleMachine );
        })
        .catch(error => {
